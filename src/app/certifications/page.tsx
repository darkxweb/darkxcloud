...
const Certifications: NextPage = () => {
  return (
    <>
      <section className="blog section" id="certifications">
        <div className="container">
          ...
          <div className="row">
            {/* Nasscom Certificate 1 */}
            <div className="blog-item padd-15">
              <div className="blog-item-inner shadow-dark">
                <div className="blog-img">
                  <img src="/imgs/blog/nasscom-logo.png" alt="Nasscom" />
                  <div className="blog-date">Nov 5, 2022</div>
                </div>
            ...
            {/* Nasscom Certificate 1 End */}

            {/* Nasscom Certificate 2 */}
            <div className="blog-item padd-15">
              <div className="blog-item-inner shadow-dark">
                <div className="blog-img">
                  <img src="/imgs/blog/nasscom-logo.png" alt="Nasscom" />
            ...
            {/* Nasscom Certificate 2 End */}

            {/* Nasscom Certificate 3 */}
            <div className="blog-item padd-15">
              <div className="blog-item-inner shadow-dark">
                <div className="blog-img">
                  <img src="/imgs/blog/nasscom-logo.png" alt="Nasscom" />
                  <div className="blog-date">May 4, 2023</div>
                </div>
                <div className="blog-info">
                  <h4 className="blog-title">
            ...
            {/* Nasscom Certificate 3 End */}

            {/* Nasscom Certificate 4 */}
            <div className="blog-item padd-15">
              <div className="blog-item-inner shadow-dark">
                <div className="blog-img">
                  <img src="/imgs/blog/nasscom-logo.png" alt="Creative Slideshow" />
                  <div className="blog-date">July 12, 2023</div>
                </div>
                <div className="blog-info">
                  <h4 className="blog-title">
            ...
            {/* Nasscom Certificate 4 End */}
            
            {/* TCS Certificate 5 */}
            <div className="blog-item padd-15">
              <div className="blog-item-inner shadow-dark">
                <div className="blog-img">
                  <img src="/imgs/blog/tcs-logo.jpg" alt="TCS" />
                  <div className="blog-date">Dec 14, 2023</div>
                </div>
                <div className="blog-info">
                  <h4 className="blog-title">
            ...
            <div className="blog-item padd-15">
              <div className="blog-item-inner shadow-dark">
                <div className="blog-img">
                  <img src="/imgs/blog/tcs-logo.jpg" alt="TCS" />
                  <div className="blog-date">June 10, 2023</div>
                </div>
                <div className="blog-info">
                  <h4 className="blog-title">
            ...
            {/* TCS Certificate 6 End */}
            
            {/* Coursera Certificate 7 */}
            <div className="blog-item padd-15">
              <div className="blog-item-inner shadow-dark">
                <div className="blog-img">
                  <img src="/imgs/blog/googlecoursera-logo.png" alt="Google" />
                  <div className="blog-date">Feb 1, 2023</div>
                </div>
                <div className="blog-info">
                  <h4 className="blog-title">
                    Google IT Support
            ...
            {/* Coursera Certificate 7 End */}
            
            {/* Coursera Certificate 8 */}
            <div className="blog-item padd-15">
              <div className="blog-item-inner shadow-dark">
                <div className="blog-img">
                  <img src="/imgs/blog/meta-logo.png" alt="Meta" />
            ...
            {/* Coursera Certificate 8 End */}
            
            {/* Coursera Certificate 9 */}
            <div className="blog-item padd-15">
              <div className="blog-item-inner shadow-dark">
                <div className="blog-img">
                  <img src="/imgs/blog/coursera-logo.png" alt="Coursera" />
                  <div className="blog-date">Nov 18, 2021</div>
                </div>
                <div className="blog-info">
                  <h4 className="blog-title">
            ...
            {/* Coursera Certificate 9 End */}

            {/* Accenture Certificate 10 */}
            <div className="blog-item padd-15">
              <div className="blog-item-inner shadow-dark">
                <div className="blog-img">
                  <img src="/imgs/blog/accenture-logo.png" alt="Accenture" />
            ...
            {/* Accenture Certificate 10 End */}

            {/* Accenture Certificate 11 */}
            <div className="blog-item padd-15">
              <div className="blog-item-inner shadow-dark">
                <div className="blog-img">
                  <img src="/imgs/blog/accenture-logo.png" alt="Accenture" />
                  <div className="blog-date">Jan 11, 2023</div>
                </div>
                <div className="blog-info">
                  <h4 className="blog-title">
                    Acquiring Data 
            ...
            {/* Accenture Certificate 11 End */}

            {/* SimpliLearn Certificate 12 */}
            <div className="blog-item padd-15">
              <div className="blog-item-inner shadow-dark">
                <div className="blog-img">
                  <img src="/imgs/blog/simplilearn-logo.png" alt="Simpliearn" />
                  <div className="blog-date">Dec 6, 2023</div>
                </div>
                <div className="blog-info">
                  <h4 className="blog-title">
            ...
            {/* SimpliLearn Certificate 12 End */}

            {/* SimpliLearn Certificate 13 */}
            <div className="blog-item padd-15">
              <div className="blog-item-inner shadow-dark">
                <div className="blog-img">
                  <img src="/imgs/blog/simplilearn-logo.png" alt="SimpliLearn" />
                  <div className="blog-date">Dec 7, 2023</div>
                </div>
                <div className="blog-info">
                  <h4 className="blog-title">
            ...
            {/* SimpliLearn Certificate 13 End */}

            
            {/* Datamatics Certificate 14 */}
            <div className="blog-item padd-15">
              <div className="blog-item-inner shadow-dark">
                <div className="blog-img">
                  <img src="/imgs/blog/datamatics-logo.png" alt="Datamatics" />
                  <div className="blog-date">Jan 30, 2023</div>
                </div>
                <div className="blog-info">
                  <h4 className="blog-title">
                    Trubot Designer
            ...
            {/* Datamatics Certificate 14 End */}

            {/* Great Learning Certificate 15 */}
            <div className="blog-item padd-15">
              <div className="blog-item-inner shadow-dark">
                <div className="blog-img">
                  <img src="/imgs/blog/greatlearning-logo.png" alt="Great Learning" />
                  <div className="blog-date">Dec, 2023</div>
                </div>
                <div className="blog-info">
                  <h4 className="blog-title">
                  UI / UX for Beginners
            ...
            {/* Great Learning Certificate 15 End */}

            {/* Great Learning Certificate 16 */}
            <div className="blog-item padd-15">
              <div className="blog-item-inner shadow-dark">
                <div className="blog-img">
                  <img src="/imgs/blog/greatlearning-logo.png" alt="Great Learning" />
            ...
            {/* Great Learning Certificate 16 End */}

            {/* Great Learning Certificate 17 */}
            <div className="blog-item padd-15">
              <div className="blog-item-inner shadow-dark">
                <div className="blog-img">
                  <img src="/imgs/blog/greatlearning-logo.png" alt="Great Learning" />
            ...
            {/* Great Learning Certificate 17 End */}
